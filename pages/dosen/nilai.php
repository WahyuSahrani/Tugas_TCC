...
$dosen = mysqli_query($conn, "SELECT * FROM mata_kuliah 
        INNER JOIN dosen ON mata_kuliah.nip = dosen.nip
        WHERE mata_kuliah.nip = '$nip'");
          ...
          <tbody>          
            ...
            <tr>
              ...
              <td style="text-align: center;">  
               <a href="?pages=lihat&kd_mk=<?= $row["kd_mk"]; ?>"  class="btn btn-success btn-xs">Lihat Peserta</a>
              </td>
            </tr>           
           <?php $i++; ?>
